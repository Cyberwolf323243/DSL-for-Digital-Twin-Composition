...
namespace DeviceSimulator
{
    public static class AzureIoTHub
    {
        ...
        /// </summary>
        private const string iotHubConnectionString = "HostName=DTCarIOTHub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=PbR2xoX0+1bMqPnh4q4rjoxuuSPgZ+lfkAIoTGxguhI=";
        ...
        /// </summary>
        private const string deviceConnectionString = "HostName=DTCarIOTHub.azure-devices.net;DeviceId=engine;SharedAccessKey=HJlZ7eqh5IEJtvhZiHb/H8YllBYXV2tC/AIoTFjFw2c=";
        ...
        public static async Task SendDeviceToCloudMessageAsync(CancellationToken cancelToken)
        {
            ...
            double maxUtilization = 70.0D;
            var rand = new Random();
            double currentUtilization = 0;

            while (!cancelToken.IsCancellationRequested)
            {
                currentUtilization = Math.Min(currentUtilization + rand.NextDouble()*20, maxUtilization);
